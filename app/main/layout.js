...
const MainLayout = ({ children }) => {
  ...
  return (
    <div className="grid grid-cols-12">
      <div
        className="col-start-1 col-end-13 md:col-start-1 md:col-end-7 bg-white flex justify-center items-start pt-20 min-h-screen">
        {children}
      </div>
      <div
        className="col-start-1 col-end-13 md:col-start-7 md:col-end-13 bg-primary flex flex-col md:fixed md:right-0 md:top-0 md:w-1/2 md:h-screen">
        <div className="flex flex-col md:flex-1 bg-primary relative">
          <div
            className="absolute top-0 right-0 transition-all m-2 bg-white rounded-md flex justify-center items-center hover:bg-primary-400 hover:cursor-pointer">
